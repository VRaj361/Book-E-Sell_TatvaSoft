                ...
                <div class="row g-0">
                  <div class="col-lg-6">
                    <div class="card-body p-md-2 mx-md-4">
                      ...
                      <form class="mb-4" action="EditDataServletModify1">
                        <p>Edit Product</p>
      						<%ArrayList<SetDataBook> arr=(ArrayList<SetDataBook>)request.getAttribute("ModifyData_EDS");
      						
      						for(SetDataBook bean:arr){
      						
      						%>
                        <div class="form-outline mb-2 ">
                          <input type="text" id="form2Example11" class="form-control" placeholder="Full Name" name="fullname_e" value="<%=bean.getFullname() %>" />
                          <label class="form-label" for="form2Example11">Full Name</label>
                          <p class="text-danger">${fullname_error}</p>
                        </div>
                        <div class="form-outline mb-2">
                          <input type="text" id="form2Example11" class="form-control" placeholder="Title" name="title_e" value="<%=bean.getTitle() %>"  >
                          <label class="form-label" for="form2Example11">Title</label>
                          <p class="text-danger">${title_error}</p>
                        </div>
                        
                        <div class="form-outline mb-2">
                          <input type="text" id="form2Example22" class="form-control " placeholder="Description" name="descrption_e" value="<%=bean.getDescription()%>"/>
                        ...
                        <div class="form-outline mb-2 d-inline w-50 ">
                            <input type="text" id="form2Example22" class="form-control w-25  d-inline" placeholder="Price" name="price_e" value="<%= bean.getPrice() %>" />
                        ...
                        <div class="custom-file form-outline mb-4">
                            <input type="text" class="custom-file-input form-control" id="customFile" placeholder="Enter URL" name="url_e" value="<%=bean.getUrl() %> "> 
