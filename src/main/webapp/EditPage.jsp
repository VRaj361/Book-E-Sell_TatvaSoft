                  ...
                  <div class="col-lg-6">
                    <div class="card-body p-md-2 mx-md-4">
                      ...
                      <form>
                        ...
                        <div class="form-outline mb-2">
                          <input type="email" id="form2Example11" class="form-control" placeholder="Title"/>
                        ...
                        <div class="form-outline mb-2">
                          <input type="text" id="form2Example22" class="form-control " placeholder="Description" />
                        ...
                        <div class="text-center pt-1 pb-1 ">
                          <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3 form-control " type="button">Save</button>
