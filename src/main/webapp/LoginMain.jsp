          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              <li class="nav-item mx-2">
                <a class="nav-link active addtocard"  href="LoginMain.jsp">Login</a>
              </li>
              <li class="nav-item">
                <a class="nav-link addtocard" href="SignupMain.jsp">Register</a>
              </li>
            </ul>
          </div>
          <form class="d-flex">
                    ...
                    <div class="card-body p-md-3 mx-md-4">
                      ...
                      <div class="text-center">
                        <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/lotus.webp" style="width: 155px;
                         " alt="logo">
                        <h4 class="mt-1 mb-1 pb-1">Books are a uniquely portable magic.</h4>
                      </div>
      
                      <form action="LoginMainServlet" method="post">
                        <p>Please login to your account</p>
      
                        <div class="form-outline mb-2">
                          <input type="text" id="form2Example11" class="form-control" placeholder="Phone number or email address" name="username_l"/>
                          <label class="form-label" for="form2Example11">Username</label>
                          <p class="text-danger" >${username_EL }</p>
                        </div>
                        ...
                        <div class="text-center pt-1 pb-1 ">
                          <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3 form-control " type="submit">Log in</button>
